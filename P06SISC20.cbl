       ...
       *>Declaração do corpo do programa
       procedure division using lnk-controle.
       ...
       2000-processamento section.
           if   lnk-tipo-usuario-adm = "x" or lnk-tipo-usuario-adm = "X" then
               perform until ws-resul-sair = "x" or ws-resul-sair = "X"
                   display "'BU' - Buscar um registro"
                   display "'BV' - Buscar varios registros"
                   display "'BT' - Buscar todos os registros"
                   display "'DT' - Deletar um registro"
                   accept ws-operacao
